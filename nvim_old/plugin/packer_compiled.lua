...
_G.packer_plugins = {
  ...
  ["cmp-conventionalcommits"] = {
    loaded = true,
    path = "/Users/admin/.local/share/nvim/site/pack/packer/start/cmp-conventionalcommits",
    url = "https://github.com/davidsierradz/cmp-conventionalcommits"
  },
  ["cmp-fish"] = {
    loaded = true,
    path = "/Users/admin/.local/share/nvim/site/pack/packer/start/cmp-fish",
  ...
  ["vim-prettier"] = {
    loaded = true,
    path = "/Users/admin/.local/share/nvim/site/pack/packer/start/vim-prettier",
